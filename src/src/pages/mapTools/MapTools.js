...
useEffect(()=>{
    ...
    <Row className='m-0 '>
        <Col className='col-5 col-xxl-3 col-xl-4 overflow-auto' style={{ height: "91vh" }}>
            <FilterLeft  response={response} crops={crops} setCarouselMajorItems={setCarouselMajorItems} setCarouselLandraceItems={setCarouselLandraceItems}></FilterLeft>
        </Col>
