    ...
    return (
        <>
         <div className="px-4 py-5 text-center container-page">
            <h1 className="display-5 fw-bold text-light shadow-text">Viewer Gap analysis</h1>
            <div className="col-lg-10 mx-auto">
                ...
                <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <Link type="button" className="btn btn-primary btn-lg px-4 text-white" to="/maptools">Go to Viewer <FontAwesomeIcon icon={faArrowRight} /></Link>
                </div>
            </div>
